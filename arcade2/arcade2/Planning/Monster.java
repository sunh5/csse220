...
public class Monster extends GameObject{
	...
	public void drawOn(Graphics2D g2) {
		...
		} else if (this.pumpedTimes>0) {
			fileName = "images/" + this.monsterType + "Pumped.png";
		} 
	    else {
	    	if(this.faceLeft){
		...
		try {
			...
			if(!this.monsterType.equals("Fygarfire")){
	...
	public void pumped() { 
		...
		if (this.pumpedTimes != 3) {
			...
			if(this.getType().equals("Fygar")){
				this.world.player.addPoints(300);
			}
			else if(this.getType().equals("Pooka")){
	...
	protected void normalMove() {
		...
		if(!this.forwardMove(upMovable, rightMovable, leftMovable,downMovable)){
