...
public class ByoLabel extends ByoComponent {
	 ...
	 * 
	 * Note that drawing text to a specific size can sometimes by approximate Don't
	 * worry if it is off by a pixel or two
	 * 
	...
	public void drawOn(Graphics2D g2) {
		g2.setFont(FONT);
		fillTextRectangle(getX(), getY()+6, getWidth()-5, getHeight()-5, text, g2);
	}
